...
public class Laporan_data_jadwal extends javax.swing.JFrame {

    /**
     * Creates new form Laporan_data_kelas
     */
    public Laporan_data_jadwal() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Laporan_data_jadwal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Laporan_data_jadwal().setVisible(true);
            }
        });
    }
