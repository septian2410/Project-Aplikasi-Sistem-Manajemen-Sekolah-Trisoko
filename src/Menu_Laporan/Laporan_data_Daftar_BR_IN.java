...
public class Laporan_data_Daftar_BR_IN extends javax.swing.JFrame {

    /**
     * Creates new form Laporan_data_lab_ak
     */
    public Laporan_data_Daftar_BR_IN() {
        initComponents();
     ...
     private void showdata( ){
       DefaultTableModel model = new DefaultTableModel();
        ...
        model.addColumn("Model/Merek");
        model.addColumn("Keadaan");
        model.addColumn("Keterangan");
        try {
            int no = 1;
            String sql = "SELECT * FROM tb_in_barang";
    ...
    private void initComponents() {
        ...
        tabel_BARANG_IN.setMaximumSize(new java.awt.Dimension(2147483647, 496));
        tabel_BARANG_IN.setMinimumSize(new java.awt.Dimension(135, 496));
        tabel_BARANG_IN.setPreferredSize(new java.awt.Dimension(675, 496));
    ...
    private void btnPRINTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPRINTActionPerformed
       try{
        InputStream file = getClass().getResourceAsStream("/Menu_Inventory/lap_barang_msk.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Laporan_data_Daftar_BR_IN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Laporan_data_Daftar_BR_IN().setVisible(true);
            }
        });
    }
