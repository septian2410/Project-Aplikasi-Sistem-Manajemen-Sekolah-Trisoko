...
public class Laporan_data_siswa1 extends javax.swing.JFrame {

    /**
     * Creates new form Laporan_data_siswa
     */
    public Laporan_data_siswa1() {
        initComponents();
    ...
    private void showdata() {
       DefaultTableModel model = new DefaultTableModel();
        ...
        try {
            int no = 1;
            String sql = "SELECT * FROM  tb_data_siswa";
    ...
    private void initComponents() {
        ...
        table_siswa.setMaximumSize(new java.awt.Dimension(2147483647, 496));
        table_siswa.setMinimumSize(new java.awt.Dimension(135, 496));
        table_siswa.setPreferredSize(new java.awt.Dimension(675, 496));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Laporan_data_siswa1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Laporan_data_siswa1().setVisible(true);
            }
        });
    }
