...
public class Laporan_pembayaran_lain1 extends javax.swing.JFrame {

    /**
     * Creates new form Laporan_pembayaran_lain
     */
    public Laporan_pembayaran_lain1() {
        initComponents();
      ...
      private void showdata(){
        ...
        model.addColumn("Total ");
         try {
           int no = 1;
              String sql = "SELECT * FROM tb_data_bayar_lain";
            ...
            tabel_pembayaran_lain.setModel(model);
    ...
    private void initComponents() {
        ...
        tabel_pembayaran_lain = new javax.swing.JTable();
        ...
        tabel_pembayaran_lain.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tabel_pembayaran_lain.setMaximumSize(new java.awt.Dimension(2147483647, 496));
        tabel_pembayaran_lain.setMinimumSize(new java.awt.Dimension(135, 496));
        tabel_pembayaran_lain.setPreferredSize(new java.awt.Dimension(675, 496));
        jScrollPane1.setViewportView(tabel_pembayaran_lain);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Laporan_pembayaran_lain1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Laporan_pembayaran_lain1().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tabel_pembayaran_lain;
