...
public class Laporan_pembayaran_lain extends javax.swing.JFrame {

    /**
     * Creates new form Laporan_pembayaran_lain
     */
    public Laporan_pembayaran_lain() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Laporan_pembayaran_lain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Laporan_pembayaran_lain().setVisible(true);
            }
        });
    }
