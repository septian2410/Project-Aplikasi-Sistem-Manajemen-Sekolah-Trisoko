...
public class Laporan_data_Daftar_BR_OUT extends javax.swing.JFrame {

    /**
     * Creates new form Laporan_data_lab_ap
     */
    public Laporan_data_Daftar_BR_OUT() {
        initComponents();
     ...
     private void showdata(){
        ...
        model.addColumn("Tanggal Keluar");
         try {
           int no = 1;
              String sql ="SELECT * FROM tb_out_barang";
    ...
    try{
        InputStream file = getClass().getResourceAsStream("/Menu_Inventory/lap_barang_klr.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Laporan_data_Daftar_BR_OUT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Laporan_data_Daftar_BR_OUT().setVisible(true);
            }
        });
    }
