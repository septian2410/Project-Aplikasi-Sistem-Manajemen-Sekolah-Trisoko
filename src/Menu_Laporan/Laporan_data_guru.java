...
public class Laporan_data_guru extends javax.swing.JFrame {

    /**
     * Creates new form Laporan_data_guru
     */
    public Laporan_data_guru() {
        initComponents();
   ...
   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        LAP_STAFF = new javax.swing.JMenuItem();
        ...
        LAP_STAFF.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconnan/report.png"))); // NOI18N
        LAP_STAFF.setText("Staff");
        jMenu3.add(LAP_STAFF);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Laporan_data_guru.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Laporan_data_guru().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JMenuItem LAP_STAFF;
