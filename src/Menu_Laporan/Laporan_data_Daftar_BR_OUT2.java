...
public class Laporan_data_Daftar_BR_OUT2 extends javax.swing.JFrame {

    /**
     * Creates new form Laporan_data_lab_ak
     */
    public Laporan_data_Daftar_BR_OUT2() {
        initComponents();
     ...
     private void showdata( ){
      DefaultTableModel model = new DefaultTableModel();
        ...
        try {
           int no = 1;
              String sql ="SELECT * FROM tb_out_barang order by kode_barang";
            ...
            tabel_permohonan.setModel(model);
   ...
   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        tabel_permohonan = new javax.swing.JTable();
        ...
        tabel_permohonan.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tabel_permohonan.setMaximumSize(new java.awt.Dimension(2147483647, 496));
        tabel_permohonan.setMinimumSize(new java.awt.Dimension(135, 496));
        tabel_permohonan.setPreferredSize(new java.awt.Dimension(675, 496));
        jScrollPane1.setViewportView(tabel_permohonan);
    ...
    private void btnPRINTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPRINTActionPerformed
       try{
        InputStream file = getClass().getResourceAsStream("/Menu_Inventory/lap_barang_permohonan.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Laporan_data_Daftar_BR_OUT2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Laporan_data_Daftar_BR_OUT2().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tabel_permohonan;
