...
public class Laporan_data_jadwal1 extends javax.swing.JFrame {

    /**
     * Creates new form Laporan_data_kelas
     */
    public Laporan_data_jadwal1() {
        initComponents();
   ...
   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        tabel_jadwal.setMaximumSize(new java.awt.Dimension(2147483647, 496));
        tabel_jadwal.setMinimumSize(new java.awt.Dimension(135, 496));
        tabel_jadwal.setPreferredSize(new java.awt.Dimension(675, 496));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Laporan_data_jadwal1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Laporan_data_jadwal1().setVisible(true);
            }
        });
    }
